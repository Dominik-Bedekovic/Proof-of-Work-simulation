...
def run_settings():
    ...
    # Read all Tkinter variables BEFORE starting the thread.

    #

    # Tkinter variables should not be accessed from the
    ...
    progress_label.config(
        ...
        text="Starting simulation... 0 / 100"

    )

    # --------------------------------------------------------

    # Switch from settings screen to loading screen
    ...
    root.geometry(
        ...
        f"{loading_width}x{loading_height}+{x}+{y}"

    )

    # --------------------------------------------------------

    # Prevent the user from starting another simulation
...
def run_simulation_worker(
    ...
    try:
        ...
        # Tell Tkinter that the simulation has finished.

        #

        # root.after() schedules this function on the
        ...
        # Send any exception back to the Tkinter thread.
...
def simulation_progress(
    ...
    # Tkinter widgets must ONLY be modified from the

    # Tkinter main thread.

    #

    # root.after() safely schedules the update there.
...
def benchmark_progress(completed, total, message):
    ...
    # Benchmark section occupies 5 -> 25
...
def simulation_finished(data):
    ...
    progress_label.config(
        ...
        text="Simulation complete! 100 / 100"
    ...
    # Give Tkinter time to visibly show the completed bar

    # before switching to the results screen.
...
def display_results(data):
    ...
    pouw_computation_rate_label.config(
        ...
        text=(
            ...
            f"{average_pouw_computation_rate:.2f} "
    ...
    for index, (node_name, search_rate) in enumerate(
        ...
        ttk.Label(
            ...
            text=(
                ...
                f"{search_rate:.2f} computation/s"
...
def start_gui():
    ...
    loading_content_frame = ttk.Frame(

        loading_frame

    )

    loading_content_frame.grid(
    ...
    # Save the normal config/results window geometry
